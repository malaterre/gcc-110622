...
CXX=g++-13
$CXX -std=c++11 -g -m32 -O2 -o works1 $input -Wfatal-errors -Wall -Wextra -Werror -Wpedantic
if ! test "$?" = "0"; then
  exit 1
fi
( ulimit -t 10; ./works1 )
...
$CXX -std=gnu++11 -g -m32 -O2 -o fails $input -Wfatal-errors -Wall -Wextra -Werror -Wpedantic
if ! test "$?" = "0"; then
  exit 1
fi
( ulimit -t 10; ./fails )
...
$CXX -std=gnu++11 -DDOPRINT -g -m32 -O2 -o works2 $input -Wfatal-errors -Wall -Wextra -Werror -Wpedantic
if ! test "$?" = "0"; then
  exit 1
fi
( ulimit -t 10; ./works2 )
