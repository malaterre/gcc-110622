...
clang++-16 -std=c++14 -DHWY_BROKEN_EMU128=0 -DHWY_COMPILE_ONLY_EMU128 -fsanitize=memory -o works $input -Wfatal-errors -Wall -Wextra -Werror -Wpedantic -lhwy -lhwy_test 
if ! test "$?" = "0"; then
  exit 1
fi
( ulimit -t 10; ./works )
